...
export default class DataAbsen extends Component {
    ...
    getNamaKaryawan() {
        ...
        .then((response) => {
            console.log('response nama karyawan: ', response);
            setTimeout(() =>  { 
    ...
    render() {
        ...
        return (
            <View style={{flex: 1, padding: 20}}>
                ...
                >
                    <Text style={styles.button}> Add Absen </Text>
                </TouchableOpacity>
                            ...
                            <View>
                                ...
                                <View style={styles.frameEdit}>
                                    ...
                                    <Picker
                                        ...
                                        onValueChange={(cli) => this.setState({selectedName: cli})}>
                                        {   
                                    ...
                                    <Text>{this.state.dataKaryawan}</Text>
